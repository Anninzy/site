...
function Nought() {
  return (
    <div class="size-full p-[10%]">
      <div class="size-full rounded-full border-4 border-ctp-text" />
    </div>
  );
}
...
function Cross() {
  return (
    <div class="relative size-full">
      <div class="absolute left-1/2 h-full w-1 -rotate-45 bg-ctp-text" />
      <div class="absolute left-1/2 h-full w-1 rotate-45 bg-ctp-text" />
    </div>
  );
}
...
export default function () {
  ...
  const overlaySignals: Array<Signal> = [];
    ...
    function handleClick() {
      ...
      if (overlaySymbol) {
        ...
        overlaySignals[parentIndex].value = (
          <div class="absolute z-10 size-full bg-ctp-overlay2/90">
            {overlaySymbol}
          </div>
        );
      }
    ...
    return (
      <div
        class={
          ...
          " " +
          (isActive ? "border-ctp-red" : "border-ctp-crust")
        }
      >
        {overlay}
  ...
  return (
    <div class="flex flex-row flex-wrap place-items-center">
      ...
      <div class="flex grow flex-col place-items-center">
        ...
        <button
          type="button"
          class="my-8 rounded-full bg-ctp-surface0 px-4 py-2"
          onClick={handleClick}
        >
          Restart
        </button>
